<?php
    ...
    $con = mysqli_connect("localhost", "root", "dip123", "social_network") or die("Connection was not established");
    ...
    function single_post(){
        ...
        $row_posts = mysqli_fetch_array ($run_posts);
            ...
            <textarea cols='50' rows='5' name='comment' placeholder='write your reply' required='required'></textarea><br/>
