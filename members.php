    		...
    		<div class="content">
    			<!-- user timeline starts -->
    			 	...
    			 	<div id="user_details"> 
    			 		<?php
    			 			...
    			 			echo "
    			 				...
    			 				<center><img 
    			 				src='user/user_images/$user_image' width='200' height = '200' /></center>
    			 				<div id='user_mention'>
    			 ...
    			 <div id="content_timeline">
    			 	...
    			 	<h2>All Registered members on this site:</h2><br/>
                    ...
                    <?php
                                ...
                                while ($row = mysqli_fetch_array($run_members)) {
                                    ...
                                    echo "
                                        ...
                                        <a href='user_profile.php?u_id=$member_id'>
                                        <img 
                                        src='user/user_images/$member_image' width='100' height = '100' 
                                        title = '$member_name'/>
                                        </a>
